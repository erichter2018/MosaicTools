...
/// </summary>
public record SttResult(string Transcript, SttWord[] Words, float Confidence, bool IsFinal, bool SpeechFinal, double Duration, string ProviderName = "", int[]? MediumConfWordIndices = null, int[]? LowConfWordIndices = null);
